    ...
    <header className="sticky top-3 z-40 px-3 sm:px-4">
      <div className="glass-nav max-w-6xl mx-auto rounded-full px-4 sm:px-6 py-2.5 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-1 sm:gap-2">
          <Link href="/#schedule" className="hidden sm:inline-block px-3 py-2 text-sm font-medium text-court-ink/80 hover:text-court-orange-dark rounded-full hover:bg-white/50 transition-colors focus-ring">
            Schedule
          </Link>
          <Link href="/#pricing" className="hidden sm:inline-block px-3 py-2 text-sm font-medium text-court-ink/80 hover:text-court-orange-dark rounded-full hover:bg-white/50 transition-colors focus-ring">
            Pricing
          </Link>
          <Link href="/#faq" className="hidden sm:inline-block px-3 py-2 text-sm font-medium text-court-ink/80 hover:text-court-orange-dark rounded-full hover:bg-white/50 transition-colors focus-ring">
            FAQ
          </Link>
          <Link href="/track" className="hidden sm:inline-block px-3 py-2 text-sm font-medium text-court-ink/80 hover:text-court-orange-dark rounded-full hover:bg-white/50 transition-colors focus-ring">
            Track booking
          </Link>
          <Link href="/book" className="glass-btn-primary px-4 py-2.5 text-sm font-semibold text-white rounded-full transition-shadow focus-ring">
            Book Now
          </Link>
        </nav>
      </div>
