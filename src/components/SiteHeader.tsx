      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 group">
          ...
          {branding.logoUrl ? (
            ...
            <span className="inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-court-orange text-white shadow-court group-hover:animate-bounce-ball">
              <PaddleIcon className="h-5 w-5" />
            </span>
          )}
          <span className="relative inline-block h-9 w-[150px] sm:h-10 sm:w-[168px] shrink-0">
            <Image
              src="/heides-wordmark.png"
