    ...
    <header className={`site-header sticky top-3 z-40 px-3 sm:px-4 ${scrolled ? "site-header--scrolled" : ""}`}>
      <div className="site-nav-shell glass-nav max-w-6xl mx-auto rounded-full px-4 sm:px-6 py-2.5"> 
        ...
        <div className="mobile-menu md:hidden absolute left-3 right-3 top-[calc(100%+10px)] rounded-3xl bg-white/95 p-2 shadow-2xl backdrop-blur-xl" data-open={menuOpen}>
          <Link href="/#schedule" className="block rounded-2xl px-4 py-3 text-sm font-semibold text-court-ink hover:bg-court-blue-light/50">Schedule</Link>
          <Link href="/#pricing" className="block rounded-2xl px-4 py-3 text-sm font-semibold text-court-ink hover:bg-court-blue-light/50">Pricing</Link>
          <Link href="/#faq" className="block rounded-2xl px-4 py-3 text-sm font-semibold text-court-ink hover:bg-court-blue-light/50">FAQ</Link>
          <Link href="/track" className="block rounded-2xl px-4 py-3 text-sm font-semibold text-court-ink hover:bg-court-blue-light/50">Track booking</Link>
        </div>
