    ...
    >
      <div className="flex items-center gap-2.5 mb-3">
        ...
        <div>
          ...
          <p className="text-[11px] sm:text-xs text-white/60">Answers straight from our house rules — instant, no waiting on Messenger.</p>
        </div>
      </div>
      ...
      <p className="text-[10px] text-white/35 mt-3">
        Trained only on our {FAQ_ENTRIES.length} house FAQs — for anything else, our team on Facebook has you covered.
      </p>
    </motion.div>
  );
}
