    ...
    <ModalPortal>
      ...
      >
        ...
        >
          ...
          {/* object-contain (not cover) + a natural, near-square aspect box
              so the full ad graphic always shows — admin-uploaded promo art
              is often square-ish and text/logos sit close to the edges,
              which object-cover was cropping into. If a video is set, it
              plays in place of the photo (the photo is still stored/used as
              the poster frame and as the fallback if video is later removed). */}
