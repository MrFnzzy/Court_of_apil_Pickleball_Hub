...
const FIELDS: { key: keyof Colors; label: string; hint: string }[] = [
  ...
  { key: "colorEnergyCyan", label: "Energy cyan", hint: "Promo-slash FX, promo box glow, discount badges" },
  { key: "colorEnergyRed", label: "Energy red", hint: "Promo-slash FX, discount badges, applied-code accent" },
];
...
export default function AdminColors() {
    ...
    fetch("/api/admin/site-settings")
      ...
      .then((d) =>
        setValues({
          ...
          colorEnergyCyan: d.settings.colorEnergyCyan,
          colorEnergyRed: d.settings.colorEnergyRed,
        })
      )
  ...
  return (
    <form onSubmit={handleSave} className="rounded-court glass-panel p-5 sm:p-6 max-w-2xl">
