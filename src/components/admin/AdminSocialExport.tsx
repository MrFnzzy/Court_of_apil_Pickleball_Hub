...
//
// Colors are pulled straight from the site palette instead of generic
// traffic-light green/red: court-blue for "you can grab this" and
// court-orange for "someone already has it" — the same two accents used
// everywhere else on the site, so the post looks unmistakably "us" at a
// glance, with unavailable hours receding into a quiet cream/ink neutral.
const BUCKET_STYLE: Record<
  ReturnType<typeof bucketFor>,
  { base: string; shadow: string; sheen: string; solid: string }
> = {
  available: {
    base: "radial-gradient(120% 140% at 28% 20%, #c7eeff 0%, #6cd4ff 45%, #2fa8d9 100%)",
    shadow: "0 2px 5px rgba(47,168,217,0.5), inset 0 1px 1px rgba(255,255,255,0.75), inset 0 -2px 3px rgba(23,58,69,0.25)",
...
function defaultElements(): CanvasElement[] {
  return [{ id: uid(), kind: "schedule", width: 460, x: 40, y: 46, scale: 0.86, z: 1 }];
}
          ...
          >
            ...
            >
              ...
              >
                ...
                <div className="relative flex items-center justify-center gap-2 pt-3.5 pb-4 px-4">
              ...
              <div className="relative">
                {scheduleLoading && schedule.length === 0 ? (
                  ...
                  <div className="relative" style={{ display: "grid", gridTemplateColumns: "50px 1fr 1fr", gap: 3, padding: "10px 9px 6px" }}>
                    ...
                    {schedule.map((day, i) => (
                      <div
                        ...
                        className="relative overflow-hidden text-white text-center py-1.5 px-1 rounded-xl"
                      >
                        <div
                ...
                <div className="relative flex flex-wrap items-center gap-1.5 px-3.5 py-3 border-t border-dashed border-court-orange-dark/25">
