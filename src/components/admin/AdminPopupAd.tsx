    ...
    <div className="space-y-6">
      ...
      <div className="rounded-court glass-panel p-5 sm:p-6">
        ...
        <p className="text-sm text-court-ink/60 mb-4">
          ...
          preview frame before it plays). Leave this empty to keep showing just the photo. MP4, WebM, Ogg, or
          MOV — up to 50MB.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start">
          {ad.videoUrl ? (
            <video
              ...
              className="h-32 w-52 shrink-0 rounded-xl overflow-hidden border-2 border-court-ink/10 bg-court-ink/5 object-contain"
              controls
              muted
            />
          ) : (
