    ...
    <div className="space-y-6">
      ...
      <div className="rounded-court glass-panel p-5 sm:p-6">
        ...
        <p className="text-sm text-court-ink/60 mb-4">
          ...
          preview frame before it plays). Leave this empty to keep showing just the photo. Any common video
          format works — MP4, MOV (including iPhone HEVC), WebM, AVI, MKV — it's automatically converted on
          upload to a version every browser can play. Up to 100MB.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 items-start">
            ...
            <div className="shrink-0">
              ...
              {videoPreviewFailed && (
                <p className="text-xs text-red-600 mt-1.5 max-w-52">
                  This browser can't play this video file — it's likely an unsupported format/codec (e.g. HEVC
                  .mov). Try re-exporting as MP4 (H.264).
                </p>
              )}
            </div>
          ) : (
          ...
          <div className="flex flex-col gap-2">
            <label className="focus-ring inline-flex cursor-pointer items-center gap-2 rounded-full bg-court-orange text-white px-5 py-2.5 text-sm font-semibold hover:bg-court-orange-dark">
              {uploadingVideo ? "Uploading & converting…" : ad.videoUrl ? "Replace video" : "Upload video"}
              <input
                type="file"
                accept="video/*,.mov,.avi,.mkv,.wmv,.flv,.3gp"
                className="hidden"
