...
function average(f: FeedbackEntry): number {
  return (f.overallRating + f.venueRating + f.serviceRating + f.valueRating) / 4;
}
...
export default function AdminFeedback() {
  ...
  const summary = useMemo(() => {
    ...
    const avg = (key: keyof Pick<FeedbackEntry, "overallRating" | "venueRating" | "serviceRating" | "valueRating">) =>
      ...
      <div className="rounded-court bg-white border-2 border-court-blue/20 shadow-court p-5 sm:p-6 mb-6">
        ...
        {summary && (
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            ...
            <SummaryStat label="Service" value={summary.service.toFixed(1)} suffix="★" />
          </div>
        )}
      </div>
          ...
          {feedback.map((f, i) => (
            ...
            >
              ...
              <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-2">
                ...
                <RatingChip label="Service" value={f.serviceRating} />
