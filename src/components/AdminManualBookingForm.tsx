  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-3 sm:p-6" role="dialog" aria-modal="true">
      <button
        ...
        onClick={onClose}
        className="absolute inset-0 bg-court-ink/60 backdrop-blur-sm"
      />

      <div className="relative w-full max-w-4xl max-h-[92vh] overflow-y-auto rounded-court bg-white shadow-court-lg border-2 border-court-orange/20">
