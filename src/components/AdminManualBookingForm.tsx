...
export default function AdminManualBookingForm({
  ...
  return (
    <div className="fixed inset-0 z-[100]" role="dialog" aria-modal="true">
      ...
      {/* This flex layer only centers the card — it does NOT scroll itself.
          Centered flex/grid children that overflow their container are
          unreliable to scroll in browsers (the overflowing edge can end up
          unreachable). Instead the card below caps its own height and
          scrolls internally, which is reliable regardless of viewport size
          or any ancestor's layout quirks. */}
      <div className="fixed inset-0 flex items-center justify-center p-3 sm:p-6">
        <div className="relative w-full max-w-4xl max-h-[90vh] overflow-y-auto overscroll-contain rounded-court bg-white shadow-court-lg border-2 border-court-orange/20">
