...
export default function AdminManualBookingForm({
  ...
  return (
    <div className="fixed inset-0 z-[100]" role="dialog" aria-modal="true">
      ...
      {/* This wrapper is the actual scroll container — full-screen, always
          scrollable, so a tall form on a short viewport can never get stuck
      ...
      <div className="relative h-full w-full overflow-y-auto overscroll-contain">
        <div className="min-h-full flex items-start sm:items-center justify-center p-3 sm:p-6">
          <div className="relative w-full max-w-4xl my-auto rounded-court bg-white shadow-court-lg border-2 border-court-orange/20">
