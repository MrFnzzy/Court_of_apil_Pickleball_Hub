...
export default function ReservationPreview({ court360Url }: { court360Url?: string | null }) {
  ...
  return (
    <section className="reservation-preview glass-panel rounded-court p-5 sm:p-8 text-court-ink" aria-labelledby="reservation-preview-title">
      <div className="flex flex-wrap items-start justify-between gap-4">
        ...
        <div className="reservation-preview__date rounded-full bg-court-blue-light/60 px-3 py-2 text-xs font-bold text-court-blue-dark">Today · Open 20/7</div>
      </div>
