  ...
  return (
    <section className="reservation-preview glass-panel rounded-court p-5 sm:p-8 text-court-ink" aria-labelledby="reservation-preview-title">
      ...
      <div className="mt-7 grid lg:grid-cols-[1.05fr_.95fr] gap-7 items-center">
        <div className="reservation-court-wrap" aria-label="3D pickleball court preview">
          <div className="reservation-court">
            <span className="reservation-court__net" /><span className="reservation-court__line reservation-court__line--center" /><span className="reservation-court__line reservation-court__line--left" /><span className="reservation-court__line reservation-court__line--right" /><span className="reservation-court__ball" /><span className="reservation-court__paddle" />
          </div>
          <div className="reservation-court__shadow" />
        </div>
        <div>
