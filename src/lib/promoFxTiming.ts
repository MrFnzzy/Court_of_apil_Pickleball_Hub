...
export const FX = {
  ...
  // Katana glint sweep + tension chord during the pause, right before the strike
  GLINT_AT: 3950,
  TENSION_CHORD_AT: 3950,
  // Phase 5 — slash attack + impact ("ZING")
  SLASH_START: 4150,
  IMPACT_AT: 4500,
  SLASH_END: 4700,
  // Anime flourishes synced to the strike
  SPEEDLINES_AT: 4150,
  ONOMATOPOEIA_AT: 4500,
  ...
  SETTLE_END: 6500,
  SPARKLE_AT: 6300,
  // My own addition: an ink-stamp "-X% OFF" badge that stamps down right
  // after the total settles — a little bonus payoff beat.
  STAMP_AT: 6250,
