...
export const EDITABLE_SITE_SETTINGS_FIELDS: (keyof SiteSettings)[] = [
  ...
  "navBookNowLabel",
  "tickerItems",
  "reservationPreviewEyebrow",
  "reservationPreviewHeading",
  "reservationPreviewSubtext",
  "rallyEyebrow",
  "rallyHeading",
  "rallyText",
  "rallyReadyText",
...
// "YYYY-MM" months are validated as a set — dedupe + sort, same convention
// as normalizeClosedHours above.
export function normalizeBlockedMonths(months: unknown): string[] | null {
