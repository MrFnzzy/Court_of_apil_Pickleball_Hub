...
export const FAQ_ENTRIES: FAQEntry[] = [
  ...
  },
  {
    ...
    a: "Yes, rebooking is allowed up to 3 hours before your slot (or 1 hour before in case of rain), subject to court availability.",
  },
  {
  ...
  {
    q: "Is the court covered? What happens during a brownout?",
    a: "The court is open-air (not covered) and runs on solar power, so we're still open even during brownouts. Also, the court surface doesn't contain silica sand.",
  },
  {
