 ...
 * two matching high notes then a lower one, doorbell-style — plus an
 * original spoken "Dink dink, new booking, don't blink!" cue (browser
 * text-to-speech — not a recording of anyone else's branded
...
function playDingDingDongChime(ctx: AudioContext, startTime: number) {
  ...
  // below, echoing the sing-song rhythm of the spoken "dink dink...
  // don't blink" cue that follows it.
