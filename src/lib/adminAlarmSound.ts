 ...
 * harsh waveform — and it repeats twice so a brief glance-away doesn't
 * mean the admin misses it entirely. Call startRepeatingAlarm()
...
/**
 * Starts the cue, repeating up to `times` rounds (default 2) a couple
 ...
 */
export function startRepeatingAlarm(times = 2): { stop: () => void } {
