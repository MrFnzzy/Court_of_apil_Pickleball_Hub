  ...
  return (
    <div className="min-h-screen bg-court-cream flex flex-col">
      ...
      <main className="flex-1 max-w-xl w-full mx-auto px-4 sm:px-6 py-10">
        {loading ? (
          <div className="rounded-court glass-panel p-8 text-center text-court-ink/50">
            Loading…
          </div>
        ) : notFound || !booking ? (
          ...
          <div className="rounded-court glass-panel p-8 text-center wizard-step">
          ...
          <>
            ...
            <div className="rounded-court glass-panel p-5 sm:p-6 space-y-6">
