      ...
      <main>
        ...
        <div className="playbook-ticker" aria-label="Pickleball highlights">
          <div className="playbook-ticker__track">
            {["Open 24/7", "Court-ready gear", "Talisay City, Cebu", "Your next rally starts here", "Open 24/7", "Court-ready gear", "Talisay City, Cebu", "Your next rally starts here"].map((item, index) => <span className="playbook-ticker__item" key={`${item}-${index}`}><span className="playbook-ticker__dot" />{item}</span>)}
          </div>
        </div>
        ...
        <section className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
          <div className="motion-grid">
            ...
            <div className="motion-grid__wide grid sm:grid-cols-3 gap-4">
              <div className="motion-grid__card fx-tilt glass-panel rounded-court p-5 text-court-ink"><p className="text-4xl font-display font-700 text-court-orange">24/7</p><p className="mt-2 text-sm font-semibold">Court access</p><p className="mt-1 text-xs text-court-ink/60">Book the time that fits your game.</p></div>
