...
export default function AdminDashboard() {
  ...
  const [tab, setTab] = useState<
    "schedule" | "week" | "history" | "feedback" | "accounts" | "pricing" | "hours" | "design" | "music" | "discounts"
  >("schedule");
...
function RescheduleModal({
  ...
  function isSelectable(slot: SlotGridItem): boolean {
    ...
    return slot.status === "pending" && slot.booking?.id === booking.id;
  }
  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 z-50 grid place-items-center overflow-y-auto overscroll-contain bg-black/40 p-4" role="dialog" aria-modal="true">
        <div className="w-full max-w-lg max-h-[85vh] overflow-y-auto rounded-court bg-white border-2 border-court-ink/10 shadow-court p-6">
