...
export default function BookPage() {
  ...
  // booking can combine slots from two different dates (e.g. 11PM-12AM
  // tonight + 12AM-1AM tomorrow, or any other pair of dates) without
  // losing the first pick when the calendar moves to a different day.
