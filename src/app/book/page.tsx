...
import { getRecaptchaToken, preloadRecaptcha } from "@/lib/recaptchaClient";
...
export default function BookPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      // 1. Get a fresh invisible-reCAPTCHA token for this submission attempt
      //    and upload proof of payment in parallel — neither depends on the
      //    other, and doing them together keeps this from feeling any
      //    slower for real customers.
      const [recaptchaToken, uploadData] = await Promise.all([
        getRecaptchaToken(),
        (async () => {
