      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        ...
        <form onSubmit={handleSubmit} className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            {/* Step 1: date + slots */}
            {step === 1 && (
            <section key="step1" className="wizard-step rounded-court glass-panel p-5 sm:p-6">
            ...
            {/* Step 2: rentals */}
            {step === 2 && (
            <section key="step2" className="wizard-step rounded-court glass-panel p-5 sm:p-6">
            ...
            {step === 3 && (
            <section key="step3" className="wizard-step rounded-court glass-panel p-5 sm:p-6">
            ...
            {step === 4 && (
            <section key="step4" className="wizard-step rounded-court glass-panel p-5 sm:p-6">
            ...
            {/* Step 5: payment */}
            {step === 5 && (
            <section key="step5" className="wizard-step rounded-court glass-panel p-5 sm:p-6">
