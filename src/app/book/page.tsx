...
export default function BookPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setSubmitting(true);
    try {
      // 1. Shrink the screenshot client-side if it's large — phone
      //    screenshots routinely exceed the hosting platform's request
      //    size limit, which otherwise causes an opaque "not valid JSON"
      //    crash instead of a real error message. Then upload it.
      const uploadFile = await compressImageIfNeeded(file as File);
      ...
      <>
        ...
        <main className="max-w-2xl mx-auto px-4 sm:px-6 py-24">
          <div className="wizard-step rounded-court glass-panel p-8 sm:p-10 text-center">
            ...
            <h1 className="font-display font-700 text-2xl text-court-ink mb-3">
