                ...
                {([1, 2] as const).map((count) => {
                  ...
                  return (
                    <button
                      ...
                      className={`focus-ring rounded-court border-2 p-6 text-left transition-all ${
                        selected
                          ? "border-court-orange bg-court-orange/5 shadow-court"
                          : "border-court-blue-dark/20 bg-white hover:border-court-blue-dark/40"
                      }`}
                    >
                      {count === 1 ? (
                        <PaddleIcon className={`h-8 w-8 mb-3 ${selected ? "text-court-orange" : "text-court-blue-dark"}`} />
                      ) : (
                        <div className="flex -space-x-2 mb-3">
                          <PaddleIcon className={`h-8 w-8 ${selected ? "text-court-orange" : "text-court-blue-dark"}`} />
                          <PaddleIcon className={`h-8 w-8 ${selected ? "text-court-orange-dark" : "text-court-blue"}`} />
                        </div>
                      )}
