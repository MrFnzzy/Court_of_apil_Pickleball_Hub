...
import { labelForSlot, priceForSlot, rentalPrice, ballPrice, DEFAULT_PRICING, PricingSettings, RentalProduct } from "@/lib/pricing";
...
const stepVariants = {
  ...
  center: { opacity: 1, x: 0, scale: 1, transition: { duration: 0.36, ease: [0.22, 1, 0.36, 1] } },
            ...
            >
              ...
              {todayFullNotice && (
                ...
                <div className="fixed inset-0 z-50 grid place-items-center overflow-y-auto overscroll-contain bg-black/40 p-4" role="dialog" aria-modal="true">
                  <div className="relative w-full max-w-sm max-h-[85vh] overflow-y-auto rounded-court glass-panel p-6 text-center">
                    <button
                      type="button"
