...
export default function BookPage() {
  ...
  const grandTotal = courtTotal + rentalTotal + ballTotal;
        ...
        <form onSubmit={handleSubmit} className="grid lg:grid-cols-3 gap-8">
          <div className="lg:col-span-2 space-y-6">
            ...
            <section key="step1" className="wizard-step rounded-court bg-white border-2 border-court-blue/20 shadow-court p-5 sm:p-6">
              ...
              {todayFullNotice && (
                // Overlay scrolls itself instead of only centering, so this
                // stays fully reachable on any screen size rather than
                // relying on scrolling the page (which position:fixed
                // ignores) to reveal any part that doesn't fit.
