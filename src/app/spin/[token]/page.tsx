...
function StatusCard({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div data-motion-static="true" className="max-w-md mx-auto rounded-[1.75rem] spin-arena px-7 py-10 text-center wizard-step">
      ...
      .then(async (res) => {
        if (!res.ok) {
          if (!cancelled) {
            ...
            setNotFoundMessage(typeof data?.error === "string" ? data.error : null);
            setNotFound(true);
          }
          return;
        }
  ...
  return (
    <div className="min-h-screen bg-court-cream flex flex-col relative overflow-hidden">
      ...
      <main className="flex-1 w-full mx-auto px-4 sm:px-6 py-10 sm:py-14 relative">
        ...
        {/* ── Loading ── */}
        {loading ? (
          <div data-motion-static="true" className="max-w-md mx-auto rounded-[1.75rem] spin-arena px-7 py-14 text-center">
          ...
          <StatusCard title={notFoundMessage === "This spin invite has expired." ? "This invite has expired" : "Link not found"}>
            {notFoundMessage || "This spin link is invalid or has expired. If you think this is a mistake, please contact us directly."}
          </StatusCard>
          ...
          <div className="max-w-lg mx-auto">
            ...
            <div data-motion-static="true" className="spin-arena spin-arena--premium relative mx-auto px-6 pt-11 pb-8 sm:px-10 sm:pt-12 sm:pb-9 wizard-step">
              <div aria-hidden className="spin-arena__court" />
