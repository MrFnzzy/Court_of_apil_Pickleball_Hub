      ...
      <main className="flex-1 w-full mx-auto px-4 sm:px-6 py-10 sm:py-14 relative">
        ...
        {loading ? (
          ...
          <div className="max-w-lg mx-auto">
            ...
            <div className="spin-arena relative mx-auto px-5 pt-11 pb-8 sm:px-9 sm:pt-12 sm:pb-9 wizard-step">
              <div aria-hidden className="spin-arena__court" />
              ...
              <div className="relative flex flex-col items-center">
                ...
                <div
                  ...
                  style={{ width: "clamp(250px, 60vw, 380px)", height: "clamp(250px, 60vw, 380px)" }}
                >
                  ...
                  <div className="absolute inset-0 grid place-items-center pointer-events-none">
                    <span
                      className="flex items-center justify-center rounded-full bg-white border-2 border-white/70"
                      style={{
                        width: 44,
                        height: 44,
            ...
            {showResultCard && result && (
              <div
                className={`spin-ticket max-w-md mx-auto mt-8 shadow-court-lg text-center wizard-step relative overflow-hidden ${
