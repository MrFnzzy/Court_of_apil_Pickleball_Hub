...
- **Automatic "thanks for playing" + feedback (`/feedback/[token]`)** — once a confirmed booking's reserved
  ...
  built-in feedback form (star ratings for overall experience, venue/court quality, and value for money,
  plus an optional comment). Submissions show up in the admin dashboard's **Feedback** tab
